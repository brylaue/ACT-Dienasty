...
import { handleApiError, handleFetchError, safeJsonParse, safeTextParse } from '../errorHandler';
...
describe('errorHandler', () => {
	...
	describe('handleApiError', () => {
		it('should return error object with proper structure', () => {
			...
			expect(result).toHaveProperty('message', 'An error occurred while fetching data');
