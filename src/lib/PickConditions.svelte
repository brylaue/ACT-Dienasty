...
<style>
	...
	.card { border: 1px solid var(--line); border-radius: 12px; padding: 18px 20px; background: var(--fff); color: var(--ink); }
	.card + .card { margin-top: 12px; }
	.title { font-weight: 700; font-size: 1.02em; margin: 0 0 4px; }
	.held { color: var(--muted); font-size: 0.92em; margin: 0 0 10px; }
	.rule { margin: 0 0 10px; line-height: 1.5; }
	.reqs { margin: 0; padding-left: 20px; line-height: 1.5; color: var(--ink); font-size: 0.94em; }
	.src { color: var(--muted); font-size: 0.82em; margin: 10px 0 0; }
</style>
