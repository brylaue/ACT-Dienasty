...
<div class="constitution">
  ...
  <h3>[2.2 Prizes]</h3>
  <p>The amount remaining following the purchase of the divisional prizes, trophy nameplate updates, end of year awards, and payouts for 2nd and 3rd place will be allocated to the 1st place team. The champion will also be awarded the rotating trophy to possess until the crowning of the following season's champion.</p>
  <p>Second place receives 12.5% of league due available.</p>
  <p>3rd place receives 1X entry fee – 8.3% of dues available.</p>
  <p>Division winners will receive nice booze that corresponds with their respective division. <em>No more than $50 can be spent on a single bottle</em></p>
  <p>Any fines inflicted and collected by the executive committee will be added to the following year's prize money.</p>
  ...
  <p>Teams will be seeded following week 14 as follows…</p>
  <p>Division winners will each receive a playoff bid, as will two additional wild card teams</p>
  <p>Among division winners, overall ranking will determine seeding 1-3 in the tournament</p>
  <p>The two teams with the best records, who do not win their respective division will each receive a playoff bid as a wild card team (overall points will tie-break amongst wild card bids with same record)</p>
  <p>The #4 and #5 seeds will play a wild card game in week 15 to determine who will advance to play the #1 seed in week 16</p>

  <h3>[3.2.3 Championship bracket]</h3>
  <h4>Week 15 Championship Bracket</h4>
  <p>Wild card Game: Seeds #4 &amp; #5</p>
  <p>Loser of Wild Card will be awarded Pick 8 in the following Rookie Draft.</p>
  <h4>Week 16 Championship Bracket</h4>
  <p>Game 1: Seed #1 &amp; the winner of the wild card Game</p>
  <p>Game 2: Seeds #2 &amp; #3</p>
  <h4>Week 17 Championship Bracket</h4>
  <p>Championship Game: Winner of Game 1 vs Winner of Game 2</p>
  <p>WINNER=LEAGUE CHAMP – receives 1st place prize money &amp; pick 12 in next annual draft</p>
  <p>Loser is runner up – receives 2nd place prize money &amp; pick 11 in next annual draft</p>
  <p>3rd Place Game: Loser of Game 1 vs Loser of Game 2</p>
  <p>Winner receives 3rd place prize money &amp; pick 10 in next Annual draft</p>
  <p>Loser receives zero prize money &amp; pick 9 in next Annual draft</p>
  ...
  <p>Suspended players may not be placed on the IR roster.</p>
  <p>The active roster will be temporarily increased to 27 during the offseason. The exact date of the temporary roster expansion will be announced by the commissioner sometime shortly after the NFL Super Bowl.</p>
  <p>All players must be removed from the IR roster before the offseason Blind Bidding Free Agency period and returned to the temporarily expanded active roster or be dropped to the free agent pool. If there are still players on the IR at the start of the offseason free agency period, those players will automatically be dropped by the commissioner.</p>
  <p>Players on the Taxi Squad may remain there at the owner's discretion (as long as they do not violate the rules of the Taxi Squad as outlined in section 4.3), and will not count against the 27 player active roster limit during the offseason.</p>
  <p>The active roster must be cut down to 25 no later than 1 day before the first Week 1 NFL regular season game.</p>
  <p>The executive committee may distribute a monetary penalty for noncompliance of any of these rules (after ample warning and pestering)</p>
  ...
  <p>Pick 1: Worst Record</p>
  <p>Pick 2: 2nd Worst record</p>
  <p>Pick 3: 3rd worst record</p>
  <p>Pick 4: 4th worst record</p>
  <p>Pick 5: 5th worst record</p>
  <p>Pick 6: 6th worst record</p>
  <p>Pick 7: 7th worst record</p>
  <p>Pick 8: Loser of the wild card playoff game</p>
  <p>Pick 9: Week 16 loser of the 3rd &amp; 4th place game in the Playoff Bracket.</p>
  <p>Pick 10: 3rd Place</p>
  <p>Pick 11: 2nd Place (League Runner Up)</p>
  <p>Pick 12: 1st Place (League Champion)</p>
  ...
  <p>Taxi Squad players are not permitted to be traded at any time; they must first be promoted to the Active Roster to become a tradable commodity. Taxi Squad moves are NOT allowed during the annual or inaugural draft. (ie: Cannot place a player on Taxi Squad during draft in order to use all available draft picks).</p>
  <p>Suspended players may not be placed on the Taxi Squad at any time. If a player is already on the Taxi Squad and then becomes suspended, he may remain there until the next offseason, at which point he must be moved to the active roster or dropped. The Executive Committee will have final say if there are discrepancies.</p>
  ...
  <p>Trading will open directly after the inaugural draft.</p>
  <p>No trades will be allowed after Week 14 of the fantasy football season.</p>
  <p>Trades will resume after the League Championship Game, and remain open during the offseason.</p>
  <p>Trades are allowed during the annual draft. If the trade involves the draft pick that is currently on the clock, the countdown timer WILL NOT be reset. The new owner of the pick will have the remaining time to make their selection.</p>
  <p>Unlike Taxi Squad players, IR players may be traded directly from their IR roster spot. However, that player must go to an open roster spot on the receiving teams Active Roster. Once the trade has occurred, the new owner may then move that player to his IR if there is an open spot.</p>
  ...
  <p>1 quarterback</p>
  <p>2 running back</p>
  <p>2 wide receivers</p>
  <p>1 tight end</p>
  <p>1 Flex (RB/WR/TE)</p>
  <p>1 Reception Flex (WR/TE) [2026-2027 this position will transition into a 'Full Flex' (RB/WR/TE)]</p>
  <p>1 Super Flex (QB/RB/WR/TE)</p>
  ...
  <p>Owners must submit a lineup each week, even if their lineup is the same as the previous week.</p>
  <p>Owners who do not submit a complete lineup for a week, will have this week counted as one week of "inactivity".</p>
  <p>If an owner does not submit a complete lineup for 2 consecutive weeks or accumulates 4+ total weeks of "inactivity" in any one season, the executive committee will have the right to assume control of the team and manage it for the rest of the season to ensure complete lineups are set.</p>
  <p>A committee run team may not make any trades and is only allowed to add or drop players if the team cannot field a legal starting lineup due to injury or bye weeks. A league vote at the end of the season will determine if the original owner will be allowed to retain their team the following year or if a new owner should be found.</p>
  <p>Missed deadlines (roster cuts, paying league dues, returning IR players to roster, etc) may incur monetary fines as well as count as a week of "inactivity".</p>
  <p>The Commissioner and/or the Executive Committee will attempt to contact any inactive owners via email, text, or phone to issue a notification of and warning against their "inactivity" each time that it occurs. If the team is in danger of being seized by the executive committee, the inactive owner will be explicitly warned of this repercussion in the email/text/call.</p>
  <p>Hopefully this never becomes an issue, but these are the guidelines if it does.</p>
  ...
  <p>4 pts per Passing TD</p>
  <p>6 pts per All Other TD</p>
  <p>0.04 pts per Passing Yard</p>
  <p>0.1 pts per Rushing Yard</p>
  <p>0.1 pts per Receiving Yard</p>
  <p>0.5 pts per Receptions</p>
  <p>2 pts per Scored 2 pt Conversion (Thrown, Rushed, or Received)</p>
  <p>-2 pts per Fumble Lost</p>
  <p>-2 pts per Interception Thrown</p>
